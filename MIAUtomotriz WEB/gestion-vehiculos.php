...
<body>
                    ...
                    <form id="vehiculoForm" class="vehicle-form">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                pattern="[A-Z0-9]{6,7}" title="La patente debe tener entre 6 y 7 caracteres alfanuméricos en mayúsculas">    
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="marca" name="marca">
                                    ...
                                    <?php foreach ($marcas as $marca): ?>
                                        <option value="<?php echo htmlspecialchars($marca['Codigo']); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select id="modelo" name="modelo">
                                    <option value="Baleno_HB">Baleno HB</option>
                                    <?php foreach ($modelos as $modelo): ?>
                                        <option value="<?php echo htmlspecialchars($modelo['Codigo']); ?>">
            ...
            <section class="list-section">
                <div class="list-card">
                    ...
                    <div class="table-footer">
                        ...
                        <div class="pagination" role="navigation" aria-label="Paginación de vehículos">
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form id="editVehiculoForm" class="modal-form">
                <input type="hidden" id="editVehiculoId" name="vehiculo_id">
                <div class="form-grid">
                    <div class="form-group">
